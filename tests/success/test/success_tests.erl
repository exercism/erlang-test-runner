...
'5_year_divisible_by_100_not_divisible_by_400_in_common_year_test_'() ->
    {"year divisible by 100, not divisible "
     ...
     ?_assertNot(success:leap_year(2100))}.
